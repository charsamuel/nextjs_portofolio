...
export const projects = [
  {
    id: 1,
    title: "MERN Chat-app",
    des: "This chatapp is a real-time messaging app built with the MERN stack, offering secure and instant communication with user authentication and a responsive design for all devices.",
    img: "/chatapp.svg",
    iconLists: [
      "/mongodb.svg",
      "/express.svg",
  ...
  {
    id: 3,
    title: "Promptopia-AI-prompts",
    des: "Promptopia is an AI-powered web app that generates creative prompts for writing, brainstorming, and ideation. Built to inspire, it helps users unlock their creativity with just a click.",
    img: "/prompt.svg",
  ...
  },
  {
    id: 4,
    title: "Memories",
    des: "MemoriesApp is a digital journal that lets you capture and cherish your moments. Easily save and organize your memories with photos, notes, and tags, all in one secure place.",
    img: "/memories.svg",
    iconLists: [
      "/mongodb.svg",
      "/express.svg",
